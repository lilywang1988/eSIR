...
1. We add new features in `tvt.eSIR()`. Now the new function `tvt.eSIR()` adds `time_unit` which will allow users to change their time unit from 1 day to any arbitrary numbers of days. 
