...
#' 1e-10
#' @param time_unit numeric, will be the changed to an integer (ceiling) of the
#' input to indicate the time unit for each data point. The default is one-day,
#' i.e., we let each input time series data correspond to each day. If this
#' value is set to be 7, each data point represents one-week's aggregated data.
#'
#' @return
